...
cookbook 'ndb', github: "logicalclocks/ndb-chef", branch: "rondb_bench"
...
cookbook 'hopsmonitor', github: "logicalclocks/hopsmonitor-chef", branch: "rondb"
...
cookbook 'consul', github: "logicalclocks/consul-chef", branch: "rondb"
